...
{
    /// <summary>
    /// Mô tả các phép xử lý dữ liệu "chung chung" (generis)
    /// </summary>
    public interface ICommonDAL<T> where T : class
    {
        ...
        T? Get(int id);
        /// <summary>
        /// Bổ sung dữ liệu trong csdl. Hàm trả về ID của dữ liệu được bổ sung.
        /// (Trả về giá trị nhỏ hơn hoặc bằng 0 niếu lỗi)
        /// </summary>
