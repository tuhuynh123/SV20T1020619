...
{
    /// <summary>
    /// Lớp cơ sở cho các lớp biểu diễn dữ liệu kết quả của thao tác
    /// tìm kiếm, phân trang
    /// </summary>
   ...
   public class CustomerSearchResult : BasePaginationResult
    ...
    /// <summary>
    /// Kết quả tìm kiếm và lấy danh sách tỉnh/thành
    /// </summary>
    public class ProvinceSearchResult : BasePaginationResult
    {
        public List <Province> Data { get; set; } = new List<Province> ();
    }
    /// <summary>
